...
func New(mode SyncMode, stateDb neatdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain, dropPeer peerDropFn, logger log.Logger) *Downloader {
	if lightchain == nil {
		lightchain = chain
	}
...
func (d *Downloader) Progress() neatio.SyncProgress {
